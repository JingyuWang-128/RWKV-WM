...
class RWKV_Tmix_x070(MyModule):
    def __init__(self, args, layer_id):
        ...
        with torch.no_grad():
            ...
            # Raise base bias to shorten initial memory retention (smaller decay factor w).
            # The additive bias is configurable from the world model config.
            self.w0 = nn.Parameter(www.reshape(1, 1, C) + args.w0_bias + zigzag * 2.5)
