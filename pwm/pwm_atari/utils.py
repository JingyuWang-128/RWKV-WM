...
def load_config(config_path):
    ...
    # JEPA+RWKV World Model Configuration
    conf.Models.JEPA = CN()
    conf.Models.JEPA.EmbedDim = 512
    conf.Models.JEPA.NumRWKV6Layers = 4
    conf.Models.JEPA.NumHeads = 8
    conf.Models.JEPA.UseSelfAttention = True
    conf.Models.JEPA.UseDecoder = True
    conf.Models.JEPA.DecoderWeight = 1.0
    conf.Models.JEPA.DecoderWeightDecay = 0.9999
    conf.Models.JEPA.SigRegWeight = 0.09
    conf.Models.JEPA.SigRegKnots = 17
    conf.Models.JEPA.SigRegNumProj = 1024
    conf.Models.JEPA.TargetEMADecay = 0.99
    # New improvement parameters
    conf.Models.JEPA.ContrastiveWeight = 0.1
    conf.Models.JEPA.ContrastiveTemperature = 0.1
    conf.Models.JEPA.MultiStepWeight = 0.5
    conf.Models.JEPA.MultiStepHorizon = 3
