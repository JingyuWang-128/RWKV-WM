...
def build_world_model(conf, obs_type, env, action_dim, act, device, rwkv_kernel=False, rwkv_validate=False):
    if "proprio" in obs_type:
        is_proprio = True
...
if __name__ == "__main__":
    ...
    if conf.Task == "JointTrainAgent":
        ...
        world_model = build_world_model(
            ...
            conf.Models.WorldModel.RWKVValidate,
        )
